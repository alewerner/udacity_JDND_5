...
public class ItemControllerTest {
    ...
    public void setup() {
        ...
        TestUtils.injectObjects(itemController, "itemService", itemService);
    ...
    public void getItemsByName_Success() throws Exception {
        ...
        when(itemService.getItemsByName("Test item")).thenReturn(items);
    ...
    public void getItemsByName_Fail() throws Exception {
        when(itemService.getItemsByName("Test item")).thenReturn(null);
